...
def main():
    ...
    minuet_cpp.set_debug_flag(True) # Set to True to get C++ debug prints
    ...
    print(f"\n--- Phase: {'RDX'} (RDX) with {minuet_cpp.NUM_THREADS} threads ---")
    ...
    tiles_pivots_data_cpp = minuet_cpp.create_tiles_and_pivots(unique_indexed_coords_cpp, 2) # tile_size = 2
    ...
    kernel_map_result_cpp = minuet_cpp.perform_coordinate_lookup(
        ...
        tiles_pivots_data_cpp.tiles, tiles_pivots_data_cpp.pivots, 2 # tile_size = 2
    )
    ...
    current_output_dir = minuet_cpp.output_dir if hasattr(minuet_cpp, "output_dir") else PY_output_dir
    ...
    if PY_debug: # Use Python's debug flag for this section
